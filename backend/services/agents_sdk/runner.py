...
LLM Provider: Claude Opus 4.6 via GCP Vertex AI (Primary)
             Azure OpenAI GPT-5 (Fallback)
"""
...
LLM_PROVIDER = getattr(settings, 'LLM_PROVIDER', 'vertex_claude')

if LLM_PROVIDER == "vertex_claude":
    # Use Claude Opus 4.6 via Vertex AI (Primary)
    from .claude_runner import (
        ClaudePipelineRunner as PipelineAgentRunner,
        AgentResponse,
        AgentMetrics,
        RunMetrics,
        get_runner,
    ...
    logger.info("LLM Provider: Claude Opus 4.6 via GCP Vertex AI")

else:
    # Fallback to Azure OpenAI (Legacy)
    # Import all OpenAI-specific dependencies only when needed
    import asyncio
    import time
    import os
    ...
    logger.info("LLM Provider: Azure OpenAI GPT-5 (fallback)")
    ...
    # ============================================================================
    # Factory Functions (Azure OpenAI)
    # ============================================================================
