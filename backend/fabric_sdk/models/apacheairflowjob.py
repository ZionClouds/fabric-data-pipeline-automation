"""
Apache Airflow Job Models for Microsoft Fabric SDK

Converted from: knowledge/fabric/apacheairflowjob/models.go
"""
...
class CreateApacheAirflowJobRequest(BaseModel):
...
class ApacheAirflowJob(BaseModel):
...
class UpdateApacheAirflowJobDefinitionRequest(BaseModel):
    """Update Apache Airflow job public definition request payload."""
...
class UpdateApacheAirflowJobRequest(BaseModel):
