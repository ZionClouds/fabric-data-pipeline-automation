"""
KQL Queryset Models for Microsoft Fabric SDK

Converted from: knowledge/fabric/kqlqueryset/models.go
"""
...
class CreateKQLQuerysetRequest(BaseModel):
...
class UpdateKQLQuerysetDefinitionRequest(BaseModel):
...
class UpdateKQLQuerysetRequest(BaseModel):
